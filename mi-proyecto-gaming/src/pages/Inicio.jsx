...
export default function Inicio({ filtroBusqueda = '' }) {
    ...
    const obtenerJuegos = async () => {
      ...
      try {
        ...
        const respuesta = await fetch(
          "https://proyecto-final-fullstack-4pbz.onrender.com/games"
        );
  ...
  const juegosPorGenero = juegosFiltrados.reduce(
    (acc, juego) => {
